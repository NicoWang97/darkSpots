...
_fnCallbackReg:x,_fnCallbackFire:u,_fnLengthOverflow:Qa,_fnRenderer:La,_fnDataSource:z,_fnRowAttributes:Ia,_fnCalculateEnd:function(){}});h.fn.dataTable=p;h.fn.dataTableSettings=p.settings;h.fn.dataTableExt=p.ext;h.fn.DataTable=function(a){return h(this).dataTable(a).api()};h.each(p,function(a,b){h.fn.DataTable[a]=b});return h.fn.dataTable};"function"===typeof define&&define.amd?define("datatables",["darkSpots/static/vendor/jquery-datatables/media/js/jquery"],N):"object"===typeof exports?N(require("darkSpots/static/vendor/jquery-datatables/media/js/jquery")):jQuery&&!jQuery.fn.dataTable&&N(jQuery)})(window,
document);
